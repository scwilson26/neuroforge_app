...
import 'package:path_provider/path_provider.dart'; // only used in fallback
...
class _UploadPageState extends State<UploadPage> {
  ...
  Future<void> _shareZip() async {
    ...
    // Try sharing from memory (works with Gmail/Drive/etc.)
    try {
      ...
      // Fallback to writing a temporary file then sharing by path
    }

    // Fallback path-provider approach for picky targets
    try {
